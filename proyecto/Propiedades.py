...
def ver_propiedad():
    ...
    archivos_propiedades = os.listdir(ruta_propiedades)

    if not archivos_propiedades:
        print("No hay propiedades registradas.")
        return

    num_propiedad = 1

    for archivo_propiedad in archivos_propiedades:
        if archivo_propiedad == "propiedades.txt":
            continue
        ...
        nombre_propiedad = archivo_propiedad.split(".")[0]
        habitaciones = []
